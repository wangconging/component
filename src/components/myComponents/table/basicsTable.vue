<template>
  <div>
    <div class="table-content">
      <div style="margin-bottom: 10px;font-size: 15px;font-weight: 700; background: #fff;height: 40px;line-height: 40px; border-bottom: 1px solid #efefef;">
        普通使用
      </div>
    ...
    <codeShow :code1="code1" :code2="code2" :code3="code3" />
  </div>
</template>
